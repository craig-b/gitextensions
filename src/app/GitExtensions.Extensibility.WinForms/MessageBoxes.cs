...
#pragma warning disable RS0030 // Do not use banned APIs -- MessageBoxes is the approved wrapper
    public static DialogResult Show(object? owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1)
...
#pragma warning restore RS0030
    ...
    /// </summary>
    /// <returns>The <see cref="DialogResult"/> selected by the user.</returns>
    public static DialogResult Show(object? owner, string text, string caption, MessageBoxButtons buttons)
    ...
    /// </summary>
    public static void ShowError(object? owner, string text, string? caption = null)
    ...
    public static bool Confirm(object? owner, string text, string caption, MessageBoxIcon icon = MessageBoxIcon.Question, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1)
